...
export function TasksList({ tasks, deleteTask }) {
  ...
  const infoTask = ( taskPending.length  !== 0 ?
    (<>
      <h4 className="text-2xl md:text-2xl lg:text-4xl text-center my-6">Tareas Pendientes</h4>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:grid-cols-3 md:gap-3 xl:grid-cols-4 mx-6 xl:gap-4">{taskPending}</div>
